...
def image_scatter(features, images, img_res, res=4000, cval=1.):
    ...
    images = [gray_to_color(image) for image in images] # TODO: rename funnnnction from gray_to_color to 2d_to_3d
    ...
    y_coords = np.linspace(y_min, y_max, res_y) # TODO: Replace this to use a scale factor
